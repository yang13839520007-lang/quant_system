...
FIELD_EXPLANATIONS = {
    "order_price": "实际提交委托时使用的价格，用于说明本次下单计划按什么价位成交。",
    "order_shares": "实际提交委托时的股数，用于表示这笔订单准备买入或卖出的数量。",
...
MESSAGE_LABELS = {
    ...
    "no_summary": "暂无摘要",
    "search_label": "关键字筛选",
    "search_placeholder": "输入代码、状态或关键字筛选当前表格",
